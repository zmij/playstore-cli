...
Using playstore-cli somewhere? [Open a PR](https://github.com/zmij/playstore-cli/blob/master/README.md) adding yourself to the Adopters section in the README.
